...
export default async function VoicePage() {
  ...
  return <VoiceDialer logs={logs} contacts={contacts} actions={{ log: logCallAction, clear: clearCallsAction, toggleFavorite: toggleFavoriteAction, setNote: setCallNoteAction }} />;
}
