...
import {
  ...
  gradeRubricValidateAction, gradeDeploymentAction, gradeSourceCheckAction,
  gradeAppealAction, gradeAppealResolveAction,
  ...
  insightsMapAction, insightsConceptMasteryAction, insightsCohortAction, insightsDismissAction, insightsDefsAction,
  ...
  docCorrectionsAction, docCiteAction, docIntegrityAction,
  docValidateFormulasAction, docAuditTablesAction,
  ...
  qualityMetricsAction, qualityProvenanceAction, qualityProvenanceGetAction,
  qualityApprovalRequestAction, qualityApprovalStateAction,
  qualityArtifactStatusAction, qualityFreshnessAssessAction,
  qualityReadingAdaptAction,
} from "../actions";
      ...
      <BooklmEnhancements
        ...
        actions={{
          ...
          graph: {
            ...
            confidenceMap: graphConfidenceMapAction,
            competencyMap: graphCompetencyMapAction,
          },
          adapt: {
            ...
            diagnose: adaptDiagnoseAction,
            loopHistory: adaptLoopHistoryAction,
            diagnostic: adaptDiagnosticAction,
            policy: adaptPolicyAction,
            policySave: adaptPolicySaveAction,
            overrides: adaptOverridesAction,
            overrideDeactivate: adaptOverrideDeactivateAction,
            decisionControl: decisionControlAction,
            resetLevel: adaptResetLevelAction,
            modalityEffects: adaptModalityEffectsAction,
          },
          tutorAgents: {
          ...
          memory: {
            ...
            forgetScope: memoryForgetScopeAction,
            propose: memoryProposeAction,
            classroomConflict: memoryClassroomConflictAction,
            ...
            contradictions: memoryContradictionsAction,
          },
          assess: {
          ...
          integrity: {
            ...
            packet: integrityPacketAction,
            technicalEvent: integrityTechnicalEventAction,
            codeProcess: integrityCodeProcessAction,
          },
          grading: {
            ...
            rubricValidate: gradeRubricValidateAction,
            deployment: gradeDeploymentAction,
            sourceCheck: gradeSourceCheckAction,
            appeal: gradeAppealAction,
            appealResolve: gradeAppealResolveAction,
          },
          insights: {
            ...
            conceptMastery: insightsConceptMasteryAction,
          ...
          sources: {
            ...
            cite: docCiteAction,
            integrity: docIntegrityAction,
            validateFormulas: docValidateFormulasAction,
            auditTables: docAuditTablesAction,
          },
          factory: {
          ...
          quality: {
            ...
            provenance: qualityProvenanceAction,
            provenanceGet: qualityProvenanceGetAction,
            approvalRequest: qualityApprovalRequestAction,
            approvalState: qualityApprovalStateAction,
            artifactStatus: qualityArtifactStatusAction,
            freshnessAssess: qualityFreshnessAssessAction,
            readingAdapt: qualityReadingAdaptAction,
          },
