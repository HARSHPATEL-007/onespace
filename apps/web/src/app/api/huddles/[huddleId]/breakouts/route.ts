...
export async function POST(req: Request, { params }: { params: Promise<{ huddleId: string }> }) {
  ...
  try { return NextResponse.json(await svc.createBreakout(huddleId, { title: body.title, assignmentType: body.assignmentType, durationMin: body.durationMin, participantIds: body.participantIds })); }
