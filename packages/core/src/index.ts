...
export const N0VA_MODULES: N0vaModule[] = [
  ...
  { id: "cloud-search", name: "N0VA CLOUD SEARCH", codename: "Project Oracle", layer: "L3 Storage & Intelligence", phase: 2, status: "planned", description: "Unified search across the suite" },
  { id: "appscript", name: "N0VA APPSCRIPT", codename: "Project Script", layer: "L6 Platform / Admin", phase: 3, status: "planned", description: "Scripting runtime over module APIs" },
  ...
  { id: "slides", name: "N0VA SLIDES", codename: "Project Deck", layer: "L2 Content & Creation", phase: 2, status: "planned", description: "Presentations and decks" },
  { id: "meet", name: "N0VA MEET", codename: "Project Iris", layer: "L1 Communication", phase: 2, status: "planned", description: "Video meetings" },
  ...
  { id: "sites", name: "N0VA SITES", codename: "Project Forge", layer: "L2 Content & Creation", phase: 2, status: "planned", description: "Site builder over DOCS blocks" },
  ...
  { id: "admin", name: "N0VA ADMIN", codename: "Project Sovereign", layer: "L6 Platform / Admin", phase: 3, status: "planned", description: "Module policies and governance" },
  ...
  { id: "drawings", name: "N0VA DRAWINGS", codename: "Project Canvas", layer: "L2 Content & Creation", phase: 2, status: "planned", description: "Diagrams and drawings" },
  { id: "booklm", name: "N0VA BOOKLM EDUCATION", codename: "Project Scholar", layer: "L2 Content & Creation", phase: 2, status: "planned", description: "Learning sets over DOCS and VIDEOS" },
  { id: "groups", name: "N0VA GROUPS", codename: "Project Collective", layer: "L1 Communication", phase: 2, status: "planned", description: "Distribution lists and team spaces" },
  { id: "workspace-studio", name: "N0VA WORKSPACE STUDIO", codename: "Project Automaton", layer: "L6 Platform / Admin", phase: 3, status: "planned", description: "Automations and agent orchestration" },
  { id: "pics", name: "N0VA PICS", codename: "Project Gallery", layer: "L2 Content & Creation", phase: 2, status: "planned", description: "Photo and image manager" },
  { id: "insights", name: "N0VA INSIGHTS", codename: "Project Lens", layer: "L3 Storage & Intelligence", phase: 3, status: "planned", description: "Dashboards over audit and usage" },
  { id: "endpoint-management", name: "N0VA ENDPOINT MANAGEMENT", codename: "Project Sentinel", layer: "L6 Platform / Admin", phase: 3, status: "planned", description: "Device registry and compliance" },
  { id: "appset", name: "N0VA APPSET", codename: "Project Forge Apps", layer: "L6 Platform / Admin", phase: 3, status: "planned", description: "No-code app builder" },
  { id: "admin-console", name: "N0VA ADMIN CONSOLE", codename: "Project Overseer", layer: "L6 Platform / Admin", phase: 3, status: "planned", description: "Users, roles, security and audit" },
  { id: "vault", name: "N0VA VAULT", codename: "Project Fortress", layer: "L3 Storage & Intelligence", phase: 3, status: "planned", description: "Encrypted secrets and credentials" },
  ...
  { id: "voice", name: "N0VA VOICE", codename: "Project Echo", layer: "L1 Communication", phase: 2, status: "planned", description: "Voice calls" },
  { id: "videos", name: "N0VA VIDEOS", codename: "Project Reel", layer: "L2 Content & Creation", phase: 2, status: "planned", description: "Video library" },
