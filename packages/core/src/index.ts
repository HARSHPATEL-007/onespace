...
export const N0VA_MODULES: N0vaModule[] = [
  ...
  { id: "ads-marketing", name: "N0VA ADS & MARKETING", codename: "Project Beacon", layer: "L4 Business Ops", phase: 4, status: "live", description: "Campaigns, audiences and ads" },
  ...
  { id: "sales", name: "N0VA SALES", codename: "Project Ares", layer: "L4 Business Ops", phase: 4, status: "live", description: "Pipeline CRM" },
  { id: "revenue", name: "N0VA REVENUE", codename: "Project Yield", layer: "L4 Business Ops", phase: 4, status: "live", description: "Billing and subscriptions" },
  { id: "customer-experience", name: "N0VA CUSTOMER EXPERIENCE", codename: "Project Aegis", layer: "L4 Business Ops", phase: 4, status: "live", description: "Support tickets and CSAT" },
